...
/**
 * strtow - split it into two
 * @str: the string
 *
 * Return: returns a pointer to an array on success
 */
...
/**
 * create_word - this function creates and inserts an element
 * @words: the array of strings
 * @str: the string
 * @start: the starting index of the word
 * @end: the stopping index of the word
 * @index: the index of the array to insert
 */
